...
export const DMX_COHERENCE = { CH1: 127, CH2: 85, CH3: 165, CH10: 210 } as const;
export const DMX_CONFIG = { modeDefault: 'synth' as DMXMode, rateHz: 44, min: 0, max: 255, bridge: { wsUrl: 'ws://localhost:8081', artnetPort: 6454, sacnPort: 5568 } as const } as const;
